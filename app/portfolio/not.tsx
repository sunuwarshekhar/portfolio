...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-skyblue to-slate-900 text-white">
      {/* Navigation */}
      <nav
              ...
              {["home", "about", "skills", "projects", "contact"].map(
                (item) => (
                  <button
                    key={item}
                    onClick={() => scrollToSection(item)}
                    className="block w-full text-left px-4 py-2 capitalize hover:text-purple-400 hover:bg-purple-400/10 transition-colors"
                  >
                    {item}
                  </button>
                )
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <h2 className="text-2xl md:text-3xl text-purple-300 mb-4 font-semibold">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-200"
            >
              View Projects
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="px-8 py-3 border-2 border-purple-400 rounded-full font-semibold hover:bg-purple-400/10 transition-all duration-200"
            >
              Get In Touch
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                experience building scalable and interactive web applications. I
                specialize in JavaScript and TypeScript, with strong expertise
                in React, Next.js, and modern state management solutions.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-white font-medium">
                      Software Engineer, Full Stack - Waft Tech
                    </p>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <MapPin size={20} className="text-purple-400 mr-2" />
      ...
      <section id="projects" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            {projects.map((project, index) => {
              ...
              return (
                <a
                  ...
                  className="bg-white/5 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group hover:scale-105 cursor-pointer border border-transparent hover:border-purple-400/30"
                >
                  <div className="text-center">
                    <div
          ...
          <h2 className="text-center text-2xl md:text-2xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mt-4 md:mt-12">
            And many more...
          </h2>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 px-4 ">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white/5 rounded-xl p-6 hover:bg-white/10 transition-colors">
              <div className="w-12 h-12 text-purple-400 mx-auto mb-4 flex items-center justify-center">
          ...
          <a
            href="mailto:forofficialshekhar@gmail.com"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-200"
          >
      ...
      <footer className="py-8 text-center border-t border-white/10">
        <p className="text-gray-400">
          © 2025 Shekhar Sunuwar. Built with React & Tailwind CSS
        </p>
      </footer>
    </div>
  );
